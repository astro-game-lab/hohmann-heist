...
const samples: AllMessageParams = {
  ...
  'footer.physics': {},
  'footer.build': {},
  'footer.buildDetail': { commit: 'ae569e9' },

  'board.actName': { act: 1 },
  'board.actProgress': { bronzed: 3, total: 4 },
  'board.actLocked': { requiredAct: 2, required: 2, earned: 1 },
  'board.cardNumber': { index: 5 },
  'board.cardLabel': { index: 5, title: 'Tailgate' },
  'board.lockedCardNumber': {},
  'board.par': { dvMps: 216.6823 },
  'board.best': { dvMps: 217.4 },
  'board.notAttempted': {},
  'board.next': {},
  'board.credits': { kilocredits: 84.5 },
  'board.creditsLabel': {},
  'board.backToTitle': {},
  'board.settings': {},
  'board.cardsLabel': { act: 1 },
  'board.daily.heading': {},
  'board.daily.notAttempted': {},
  'board.daily.noSubmissions': {},
  'board.daily.yourBest': {},
  'board.lockedContract.heading': {},
  'board.lockedContract.back': {},

  'state.error.heading': {},
  'state.error.body': {},
  'state.error.back': {},
  'state.error.detail': { message: 'Cannot read properties of undefined' },
  'state.scenario.heading': { id: 'c05-tailgate' },
  'state.scenario.body': {},
  'state.scenario.field': { path: '/ship/dvBudget_mps', detail: 'must be a number' },
  'state.scenario.report': {},
  'state.replay.invalidHeading': {},
  'state.replay.invalidBody': {},
  'state.replay.futureHeading': {},
  'state.replay.futureBody': { found: 2, supported: 1 },
  'state.replay.release': {},
  'state.canvas.heading': {},
  'state.canvas.body': {},
  'state.canvas.tier1': {},
  'state.canvas.tier2': {},
  ...
  'planner.assists.elements': {},
  'planner.assists.elementsHint': {},
  'planner.assists.closestApproach': {},
  'planner.assists.closestApproachHint': {},
  'planner.assists.snapping': {},
  'planner.assists.snappingHint': {},
  'planner.assists.constraints': {},
  'planner.assists.constraintsHint': {},
  'planner.assists.targetingComputer': {},
  'planner.assists.targetingComputerHint': {},
  'planner.assists.porkchop': {},
  'planner.assists.porkchopHint': {},
  'planner.assists.coachMarks': {},
  'planner.assists.coachMarksHint': {},
  'planner.assists.prediction': {},
  'planner.assists.predictionHint': {},
  'planner.assists.effectBlind': {},
  'planner.assists.effectCaps': {},
  'planner.assists.defaultOn': {},
  'planner.assists.defaultOff': {},
  'planner.assists.capClean': {},
  'planner.assists.capAt': { medal: 'Silver', count: 1 },
  'planner.assists.medalSilver': {},
  'planner.history.undo': {},
  'planner.history.redo': {},
  'planner.history.nothingToUndo': {},
  'planner.history.nothingToRedo': {},
  'app.skipToContent': {},
  'keys.addNode': {},
  'keys.deleteNode': {},
  'keys.editNode': {},
  ...
  'keys.help': {},
  'keys.codex': {},
  'planner.contract.heading': {},
  'planner.contract.toggle': {},
  'planner.tab.contract': {},
  'planner.nodeMenu.label': { index: 1 },
  'planner.nodeMenu.snapPeriapsis': {},
  'planner.nodeMenu.snapApoapsis': {},
  'planner.nodeMenu.noApsides': {},
  'planner.nodeMenu.zeroDeltaV': {},
  'planner.nodeMenu.delete': {},
  'planner.nodeMenu.open': { index: 1 },
  'planner.plan.snappedTo': { kind: 'periapsis' },
  ...
  'settings.uiScale.value': { percent: 125 },
  'settings.palette.label': {},
  'settings.palette.default': {},
  'settings.palette.deuteranopia': {},
  'settings.palette.protanopia': {},
  'settings.palette.tritanopia': {},
  'settings.palette.highContrast': {},
  'settings.reduceMotion.label': {},
  'settings.reduceMotion.system': {},
  'settings.reduceMotion.on': {},
  'settings.reduceMotion.off': {},
  'settings.backgroundAnimation.label': {},
  'settings.lineWeights.label': {},
  'settings.verbosity.label': {},
  'settings.verbosity.terse': {},
  ...
  'settings.audio.note': {},
  'settings.audioMaster.label': {},
  'settings.audioEffects.label': {},
  'settings.audioAmbience.label': {},
  'settings.audioMuted.label': {},
  'settings.percent.value': { percent: 70 },
  'settings.pointerSensitivity.label': {},
  'settings.invertScrollZoom.label': {},
  'settings.bindings.label': {},
  'settings.bindings.reserved': {},
  'settings.bindings.change': { action: 'Add a burn at the scrub head' },
  'settings.bindings.changeShort': {},
  'settings.bindings.capturing': {},
  'settings.bindings.unbound': {},
  'settings.bindings.pending': {},
  'settings.bindings.conflict': { action: 'Open the selected burn’s editor' },
  'settings.bindings.swap': {},
  'settings.bindings.cancel': {},
  'settings.bindings.resetOne': { action: 'Add a burn at the scrub head' },
  'settings.bindings.resetAll': {},
  'settings.bindings.rejected': {},
  'settings.bindings.scope.briefing': {},
  'settings.bindings.scope.planner': {},
  'settings.bindings.scope.execution': {},
  'settings.bindings.scope.debrief': {},
  'settings.bindings.scope.everywhere': {},
  'settings.handle.label': {},
  'settings.handle.note': {},
  'settings.export.label': {},
  'settings.export.hint': {},
  'settings.import.label': {},
  'settings.clear.label': {},
  'settings.whatWeStore': {},
  'settings.confirm.replacing': { contracts: 3, bronze: 0, silver: 0, gold: 2, clean: 1 },
  'settings.confirm.nothing': {},
  'settings.confirm.importHeading': {},
  'settings.confirm.clearHeading': {},
  'settings.confirm.exportFirst': {},
  'settings.confirm.import': {},
  'settings.confirm.clear': {},
  'settings.confirm.cancel': {},
  'settings.import.unreadable': {},
  'settings.import.futureVersion': { found: 2, supported: 1 },
