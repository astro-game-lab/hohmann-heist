...
**Early — a planner, not yet a game.** A contract can be opened, a plan built and
inspected; there is no execution phase and no debrief, so nothing can be played to a
conclusion. The sections below describe what actually exists rather than what is
planned.
